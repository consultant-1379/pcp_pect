...
#define IPOQUE_DECAPSULATE_PLAIN_TUNNELS
    ...
    // #define IPOQUE_ENABLE_GTP_C_USER_TRACKING
...
#define IPOQUE_LAST_IMPLEMENTED_PROTOCOL        226
...
"SPDY", "CyberGhost", "Google", "FIX", "Oracle Database", "ITV", "Demand 5", \
...
#define IPOQUE_PROTOCOL_DESCRIPTION_STRING \
	...
	"ISKOORT is a voice over IP protocol.",\
